...
def train(
    *,
    ...
    grassmannian_orthogonality_loss_coef: float = -1e-6,
    orthogonality_loss_coef: float = 0.001,
    num_prototypes_per_class: int = 14,
    proto_channels: int = 128,
    dataset: str = "CUB200",
    ...
    protopnet_loss = loss_for_coefficients(
        ...
        grassmannian_orthogonality_loss_mini_batch_size=grassman_minibatch_size,
    ).to(setup["device"])
